...
const TRIAGE_OPTIONS: Array<{ value: TriageDisposition; label: string; description: string }> = [
  { value: "ASSESSMENT_REQUIRED", label: "Assessment required", description: "Open a GeoTech assessment for the district's office chief, who hands it to a branch chief or assigns a senior specialist." },
