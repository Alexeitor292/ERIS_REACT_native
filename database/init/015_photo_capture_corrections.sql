-- Append-only manual correction history for photo capture metadata.
-- Kept separate from 010_schema.sql so fresh MariaDB initialization gains the
-- feature without rewriting the authoritative base schema file.
