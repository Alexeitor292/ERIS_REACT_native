...
// ---------------------------------------------------------------------------
// Incident Workflow Tree — mobile API client
// ---------------------------------------------------------------------------
...
export function getWorkflowTree(token: string, incidentId: number) {
  return apiFetch<WorkflowTree>(`/incidents/${incidentId}/workflow-tree`, { token });
}
